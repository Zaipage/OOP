...
public class CheckoutService {
  ...
  private Product find(String productId) throws ProductNotFoundException {
    ...
    throw new ProductNotFoundException("Product " + productId + " not found"); // TODO: ganti dengan return produk yang ditemukan atau lempar Exception yang menangani jika produk tidak ditemukan
  }

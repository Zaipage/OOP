public class MahasiswaAsing extends Mahasiswa {
    ...
    MahasiswaAsing(String country) {
        // TODO: answer here
        super(); // mahassiswaAsing itu extend Mahasiswa jadi kalo manggil make super 
        // super() kosong karena konstruktor mahasiswa kosong "Mahasiswa()"
    ...
    public void perkenalkan() {
        // TODO: answer here
        System.out.println("Halo, saya mahasiswa asing dengan username " + getUsername() + " dari negara " + country);
    }
    ...
    public void daftarAsrama(Asrama asrama) {
        // TODO: answer here
        System.out.println("Mahasiswa asing dengan username " + getUsername() + " dari negara " + country + " berhasil mendaftar asrama");
